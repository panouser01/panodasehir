...
cmd1 = "ssh -p 25416 -o StrictHostKeyChecking=no root@45.43.152.18 \"mysql -u root -p'Rr9hG@tC9SZT' panodasehir -e 'SELECT images FROM Article ORDER BY createdAt DESC LIMIT 2;'\""
