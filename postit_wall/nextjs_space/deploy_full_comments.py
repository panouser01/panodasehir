...
# Upload the file
cmd1 = "scp -P 25416 -o StrictHostKeyChecking=no update_full_comments.tar.gz root@45.43.152.18:/var/www/panodasehir/"
...
cmd2 = "ssh -p 25416 -o StrictHostKeyChecking=no root@45.43.152.18 'cd /var/www/panodasehir && tar -xzf update_full_comments.tar.gz && npm run build && pm2 restart all'"
