...
print("Uploading postit-masonry-grid.tsx...")
scp = pexpect.spawn(f'scp -P {port} -o StrictHostKeyChecking=no components/postit/postit-masonry-grid.tsx {target}:/var/www/panodasehir/components/postit/postit-masonry-grid.tsx', encoding='utf-8')
