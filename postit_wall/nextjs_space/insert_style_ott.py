...
# We want to add these fields inside the style tab, before:
#                           </div>
#                       </div>
#                       );
#                     })()}
...
insertion_code = """
                             <div className="border border-gray-200 mt-6 p-4 rounded-md bg-indigo-50/30">
                               <h4 className="font-semibold text-indigo-800 flex items-center gap-2 mb-4">
                                 Stil Modu OTT (Satır/Slayder) Parametreleri
                               </h4>
...
if target in content:
    ...
    print("Target block not found. Checking if it already exists or using a different match.")
