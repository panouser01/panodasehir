...
scp = pexpect.spawn('scp -P 25416 -o StrictHostKeyChecking=no update-editor-changes.tar.gz root@45.43.152.18:/var/www/panodasehir/', encoding='utf-8')
...
try:
    ...
    one_liner = "cd /var/www/panodasehir && tar -xzvf update-editor-changes.tar.gz && npm run build && pm2 restart all"
