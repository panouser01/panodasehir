...
print("Uploading postit-card...")
scp = pexpect.spawn(f"scp -P {port} -o StrictHostKeyChecking=no 'components/postit/postit-card.tsx' {target}:/var/www/panodasehir/components/postit/postit-card.tsx", encoding='utf-8')
