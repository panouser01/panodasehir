...
files = [
    ...
    ('app/api/categories/route.ts', '/var/www/panodasehir/app/api/categories/route.ts'),
    ('app/api/categories/[id]/route.ts', '/var/www/panodasehir/app/api/categories/[id]/route.ts')
]
