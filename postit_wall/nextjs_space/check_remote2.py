...
try:
    ...
    ssh_child.sendline('cat /var/www/panodasehir/app/page.tsx | grep "relative px-8 py-1"')
    ssh_child.expect('#', timeout=10)
    
    ssh_child.sendline('cat /var/www/panodasehir/app/page.tsx | grep "relative px-0 py-1"')
    ssh_child.expect('#', timeout=10)
